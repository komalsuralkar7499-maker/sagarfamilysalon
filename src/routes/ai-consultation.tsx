      ...
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between gap-4 px-4 sm:px-6">
        ...
        >
          ...
          <span className="truncate font-display text-lg font-semibold tracking-wide text-noir-foreground">
            Sagar{" "}
            <span className="text-gold-gradient">Family Salon</span>
          </span>
        </Link>
        ...
        >
          ...
          <Link
            to="/contact"
            className="ml-2 rounded-full bg-primary px-5 py-2 text-sm font-semibold text-primary-foreground shadow-gold transition-transform duration-300 hover:scale-[1.03]"
          >
            Book Appointment
          </Link>
        </nav>
